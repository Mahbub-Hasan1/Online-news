    ...
    return (
        <>
            <div className="text-center sidebar-div">
                ...
                <img className="img-fluid president-img" src="https://i.imgur.com/wsdDXFD.jpg" alt="" />
            ...
            <div className="text-center sidebar-div">
                ...
                <img className="img-fluid president-img" src="https://i.imgur.com/hEaIa7d.jpg" alt="" />
